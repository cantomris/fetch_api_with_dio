...
//
//     final allDataListModel = allDataListModelFromJson(jsonString);

import 'dart:convert';

AllDataListModel allDataListModelFromJson(String str) => AllDataListModel.fromJson(json.decode(str));

String allDataListModelToJson(AllDataListModel data) => json.encode(data.toJson());

class AllDataListModel {
  AllDataListModel({
    this.results,
  });
  ...
  factory AllDataListModel.fromJson(Map<String, dynamic> json) => AllDataListModel(
...
enum HotelCampaignName { YAKN_DNEM_KONAKLAMA_NDIRIMI, ERKEN_REZERVASYON_NDIRIMI, SON_DAKIKA_FRSAT, SEZON_NDIRIMI, ERKEN_REZRVASYON_NDIRIMI, UZUN_KONAKLAMA_NDIRIM }
...
final hotelCampaignNameValues = EnumValues({
  ...
  "Son Dakika Fırsatı": HotelCampaignName.SON_DAKIKA_FRSAT,
