...
//
//     final testHotels = testHotelsFromJson(jsonString);

import 'dart:convert';

TestHotels testHotelsFromJson(String str) => TestHotels.fromJson(json.decode(str));

String testHotelsToJson(TestHotels data) => json.encode(data.toJson());
...
class TestHotels {
  ...
  factory TestHotels.fromJson(Map<String, dynamic> json) => TestHotels(
    id: json["id"],
