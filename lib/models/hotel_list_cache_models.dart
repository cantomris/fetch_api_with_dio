...
//
//     final hotelListCacheModels = hotelListCacheModelsFromJson(jsonString);

import 'dart:convert';

HotelListCacheModels hotelListCacheModelsFromJson(String str) => HotelListCacheModels.fromJson(json.decode(str));

String hotelListCacheModelsToJson(HotelListCacheModels data) => json.encode(data.toJson());

class HotelListCacheModels {
  HotelListCacheModels({
    this.id,
    this.calcTypeId,
    this.priority,
    this.isSingleBay,
  ...
  factory HotelListCacheModels.fromJson(Map<String, dynamic> json) => HotelListCacheModels(
    id: json["id"],
